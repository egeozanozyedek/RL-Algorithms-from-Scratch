...
for i in range(1):
    reward_per_episode, steps_per_episode = trainer.train_dqn(episodes=50, time_steps=200, C=4, min_replay_count=int(1024),
                                                              batch_size=int(32), learning_rate=0.00125, discount=0.95, epsilon=1,
