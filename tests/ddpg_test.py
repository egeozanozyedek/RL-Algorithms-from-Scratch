...
# actor_layers = [FullyConnected(128, "relu"), FullyConnected(256, "relu"), FullyConnected(128, "relu"), FullyConnected(action_dim, "tanh")]
# critic_layers = [FullyConnected(128, "relu"), FullyConnected(1, "linear")]
# state_layers = [FullyConnected(128, "relu"), FullyConnected(256, "relu")]
# action_layers = [FullyConnected(128, "relu")]
...
ddpg.train(episodes, actor_learning_rate, critic_learning_rate, discount_rate, tau, max_steps, render=False)